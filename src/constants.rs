...
/// Generator G (as uncompressed curve point)
pub const GENERATOR_PUB_G : [u8; 65] = [
    0x04,
...
/// Generator H (as uncompressed curve point)
pub const GENERATOR_PUB_H : [u8; 65] = [
    0x04,
...
/// Generator J (as uncompressed curve point)
pub const GENERATOR_PUB_J : [u8; 65] = [
    0x04,
